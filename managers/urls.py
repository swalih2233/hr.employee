...
urlpatterns=[
    ...
    path("leave/withdraw/<int:id>/", views.manager_withdraw_leave, name="manager_withdraw_leave"),
    ...
    # Withdrawal actions (for managers and founders to take on requests)
    path("leave/withdrawal/approve/<int:id>/<str:leave_type>/", views.approve_withdrawal, name="approve_withdrawal"),
    path("leave/withdrawal/reject/<int:id>/<str:leave_type>/", views.reject_withdrawal, name="reject_withdrawal"),
